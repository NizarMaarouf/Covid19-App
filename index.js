...
async function createChartData(continent, infoType) {
  /*go over country codes in given continent.
  for each code fetch relevant info and country name.
  put each in the relevant array.*/
  let dataLabelsArray = [];
  let dataValuesArray = [];
  let dataCodeArray = [];
  // get relevant urls
...
// ----------------------------------------------------------
// pulling data from the APIs -- generic fetch function
// ----------------------------------------------------------
